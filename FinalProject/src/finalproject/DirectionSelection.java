...
public class DirectionSelection extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("DirectionSelection.fxml"));
        stage.setTitle("Direction Selection");
